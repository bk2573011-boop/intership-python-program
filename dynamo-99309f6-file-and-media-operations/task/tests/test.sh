...
# separate verifier image. pytest + ffmpeg are baked into environment/Dockerfile, so do NOT
# install or download anything here — verify-time setup is rejected by the static checks.
#
